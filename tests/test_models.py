...
from coordinator.models import (
    TaskType, RFCState, LLMProvider, LLMConfig, ProjectDefinition,
    Task, ProjectVersion, ProjectSummary, TaskUpdate, ProjectStats,
...
def test_project_version():
    ...
    assert version.definition == '{"name": "Test Project", "description": "A test project"}'
